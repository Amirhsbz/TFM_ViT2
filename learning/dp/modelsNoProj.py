...
class ImageEncoder(nn.Module):
    # ResNet-18's GAP output width. When output_size is None, this raw
    # 512-dim feature passes straight through unprojected, matching the
    # original Diffusion Policy paper's MultiImageObsEncoder.
    RAW_OUTPUT_SIZE = 512
