...
# T3_PRETRAINED_SENSOR_NAME_MAP / T3_PRETRAINED_TACTILE_ENCODER_CHECKPOINTS_BASE_URL are imported
# lazily inside _load_t3_pretrained_checkpoint below (not at module level): they live in
# haptile_tactile_encoder.py, which itself imports ViTEncoder from this module, so a top-level
...
class ViTEncoder(timm_vit.VisionTransformer, Encoder):
    ...
    def _load_t3_pretrained_checkpoint(self, cache_dir: str = None):
        ...
        """
        from openpi.models_pytorch.haptile_tactile_encoder import (
