...
#SBATCH --job-name=train_pi0_haptile_vision_only_orange_picking
#SBATCH --gres=gpu:1
...
DATASET_NAME=Orange_picking                # must match run_convert_pi0_lerobot_tactile_raw.sh's DATASET_NAME
DEFAULT_PROMPT="Lift the orange, place it on the other side of table"            # must match run_convert_pi0_lerobot_tactile_raw.sh's DEFAULT_PROMPT
