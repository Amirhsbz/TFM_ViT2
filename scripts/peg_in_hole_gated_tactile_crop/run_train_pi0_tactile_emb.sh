...
DATASET_NAME=peg_in_hole_gated_tactile_crop
LEROBOT_REPO_ID=local/pi0_ur5e_peg_in_hole_gated_tactile_crop
EXP_NAME=peg_in_hole_gated_tactile_crop_pi0_base_tactile_emb_lora
